...
public class RestaurantSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MRestaurantPackage.TABLE: {
				MTable table = (MTable)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MRestaurantPackage.WAITER: {
				MWaiter waiter = (MWaiter)theEObject;
				T result = caseWaiter(waiter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MRestaurantPackage.BOOKING: {
				MBooking booking = (MBooking)theEObject;
				T result = caseBooking(booking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MRestaurantPackage.CUSTOMER: {
	 ...
	 * @generated
	 */
	public T caseTable(MTable object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseWaiter(MWaiter object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseBooking(MBooking object) {
		return null;
	}
