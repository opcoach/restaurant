...
public class MenuSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MMenuPackage.GROUP: {
				MGroup group = (MGroup)theEObject;
				T result = caseGroup(group);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MMenuPackage.RECIPE: {
				MRecipe recipe = (MRecipe)theEObject;
				T result = caseRecipe(recipe);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MMenuPackage.INGREDIENT: {
				MIngredient ingredient = (MIngredient)theEObject;
	 ...
	 * @generated
	 */
	public T caseMenu(MMenu object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGroup(MGroup object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRecipe(MRecipe object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseIngredient(MIngredient object) {
		return null;
	}
