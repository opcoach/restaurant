...
/**
 * This is the item provider adapter for a {@link com.opcoach.restaurant.MWaiter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WaiterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Waiter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Waiter_name_feature", "_UI_Waiter_type"),
				 MRestaurantPackage.Literals.WAITER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRestaurantPackage.Literals.WAITER__TABLES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((MWaiter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Waiter_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MWaiter.class)) {
			case MRestaurantPackage.WAITER__NAME:
