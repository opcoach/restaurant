...
/**
 * This is the item provider adapter for a {@link com.opcoach.menu.MGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MMenuPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_category_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_category_feature", "_UI_Group_type"),
				 MMenuPackage.Literals.GROUP__CATEGORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MMenuPackage.Literals.GROUP__RECIPES);
		}
	...
	public String getText(Object object) {
		String label = ((MGroup)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MGroup.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MMenuPackage.Literals.GROUP__RECIPES,
				 MMenuFactory.eINSTANCE.createRecipe()));
	}
