/**
 */
package com.opcoach.menu.provider;
...
/**
 * This is the item provider adapter for a {@link com.opcoach.menu.MRecipe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecipeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MMenuPackage.Literals.RECIPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPricePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_price_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_price_feature", "_UI_Recipe_type"),
				 MMenuPackage.Literals.RECIPE__PRICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_amount_feature", "_UI_Recipe_type"),
				 MMenuPackage.Literals.RECIPE__AMOUNT,
				 true,
				 false,
				 false,
	...
	protected void addAmountTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_amountType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_amountType_feature", "_UI_Recipe_type"),
				 MMenuPackage.Literals.RECIPE__AMOUNT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MMenuPackage.Literals.RECIPE__INGREDIENTS);
		}
	...
	public String getText(Object object) {
		String label = ((MRecipe)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MRecipe.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MMenuPackage.Literals.RECIPE__INGREDIENTS,
				 MMenuFactory.eINSTANCE.createIngredient()));
	}
